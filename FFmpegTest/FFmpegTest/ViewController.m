...
- (void)viewDidLoad
{
    ...
    _remoteMovies = @[
                      @"http://www.qeebu.com/newe/Public/Attachment/99/52958fdb45565.mp4",                     @"http://image.kaolafm.net/mz/audios/201603/10e93fd6-12b7-4119-869b-b37bcfdee05c.mp3",
...
- (void) reloadMovies
{
    ...
    [ma addObject:[bundle pathForResource:@"借口" ofType:@"mp3"]];
    [ma addObject:[bundle pathForResource:@"电视机高清测试视频短片" ofType:@"rmvb"]];
    ...
    [ma addObjectsFromArray:[bundle pathsForResourcesOfType:@"rmvb" inDirectory:@"SampleMovies"]];
